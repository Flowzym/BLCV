...
import { Settings, Palette, Eye, Brain, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      <header className="relative sticky top-0 z-20 bg-white shadow-md py-4">
        <h1 className="text-2xl font-bold text-center">Lebenslauf Designer</h1>
        <button
      ...
      <main className="flex-1 px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_4fr_1fr] gap-6 relative overflow-hidden h-full">
