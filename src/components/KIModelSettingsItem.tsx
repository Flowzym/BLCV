...
import {
  ...
  AccordionTrigger,
  AccordionContent,
} from "@/components/ui/accordion";  // ✅ korrigierter Import
          ...
          <div className="flex justify-between mt-3">
            <div className="flex items-center space-x-2">
              <StyledButton
                onClick={testModel}
                disabled={isTesting}
                className="flex items-center space-x-1 bg-purple-100 text-purple-800 hover:bg-purple-200 disabled:opacity-50"
              >
                {isTesting ? (
            ...
            <StyledButton variant="destructive" onClick={handleRemove}>
              🗑️
            </StyledButton>
          </div>
        </AccordionContent>
